...
public final class TodoDAO_Impl implements TodoDAO {
  ...
  public TodoDAO_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `tasks` (`id`,`title`,`description`,`created_date`,`priority`,`is_completed`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfTask = new EntityDeletionOrUpdateAdapter<Task>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR REPLACE `tasks` SET `id` = ?,`title` = ?,`description` = ?,`created_date` = ?,`priority` = ?,`is_completed` = ? WHERE `id` = ?";
      }
  ...
  public LiveData<List<Task>> getAllTodos() {
    final String _sql = "SELECT * FROM tasks ORDER BY created_date, priority";
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Task(_tmpTitle,_tmpDescription,_tmpCreatedDate,_tmpPriority,_tmpIs_completed);
            final int _tmpId;
  ...
  public Task getTodoById(final int id) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        _tmp_1 = _cursor.getInt(_cursorIndexOfIsCompleted);
        _tmpIs_completed = _tmp_1 != 0;
        _result = new Task(_tmpTitle,_tmpDescription,_tmpCreatedDate,_tmpPriority,_tmpIs_completed);
        final int _tmpId;
        _tmpId = _cursor.getInt(_cursorIndexOfId);
